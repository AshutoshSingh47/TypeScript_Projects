    ...
    return (
        <>
            <div className="max-lg:hidden flex flex-row items-center cursor-pointer justify-center" onClick={() => handleTheme()}>
                {
                    isdark ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" data-slot="icon" className="w-8 h-8 text-yellow-300 absolute">
